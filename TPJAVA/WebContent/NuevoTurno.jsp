			...
			<h4><b>Fecha Turno:</b></h4>
				<div class="form-row">
					<div class="form-group col-md-1">
						...
						<input type="number" class="form-control" min="1" max="31" name="dia_turno" id="dia" placeholder="01" required>
					</div>
					<div class="form-group col-md-1">
						<label for="mes"><b>Mes</b></label> 
						<input type="number" class="form-control" min="1" max="12" name="mes_turno" id="mes" placeholder="12" required>
					</div>
					<div class="form-group col-md-1">
						<label for="anio"><b>Año</b></label> 
						<input type="number" class="form-control" name="anio_turno" id="anio" placeholder="2019" required>
					</div>
			</div>
