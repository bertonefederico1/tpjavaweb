				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						<tr>
							<td>
								<div class="radio">
 									<label><input type="radio" onclick=<% if (request.getSession().getAttribute("tipo").toString().equalsIgnoreCase("nuevo_repuesto")) {%>"location='AgregarRepuesto.jsp?cuit=<%=prov.getCuit()%>'"<%} else if (request.getSession().getAttribute("tipo").toString().equalsIgnoreCase("editar_repuesto")) {%>"location='EditarRepuesto.jsp?cuit=<%=prov.getCuit()%>'"<%}%> 
