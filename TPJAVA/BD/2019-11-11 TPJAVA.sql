...
INSERT INTO `clientes` VALUES (37817242,'Juan Perez','mitre 1234','','420222'),(40121987,'Elsa Lame','catamarca 1236','elsa21@gmail.com','155422123'),(41091000,'Esteban Quito','san juan 1287','esteban.quito@hotmail.com','425678');
...
INSERT INTO `mecanicos` VALUES (1,'Hugo Salomon','san juan 1287','huguito13@gmail.com','421090'),(2,'Alberto San','Richieri 678 Bis','','');
...
INSERT INTO `repa_repuestos` VALUES (8,2,3),(11,2,1),(11,3,3),(15,2,1),(15,3,4),(16,8,1);
...
CREATE TABLE `reparaciones` (
  ...
  `precio_total` decimal(10,2) unsigned DEFAULT NULL,
  `patente` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `reparaciones` VALUES (8,'2019-09-17','2019-10-24',NULL,NULL,'Ingresada','','cambiar foco delantero','puerta derecha rayada',NULL,'HCK 456',2,'si',NULL),(9,'2019-04-16','2019-10-09',NULL,NULL,'Ingresada',NULL,'Reparar amortiguador delantero',NULL,NULL,'IPC 102',1,'no',NULL),(11,'2019-09-24','2019-10-21',NULL,NULL,'Ingresada','REPARACION REALIZADA (PRUEBA FINAL)','test',NULL,NULL,'GCJ 523',2,'si',1400.40),(13,'2019-10-09','2019-10-21',NULL,NULL,'Ingresada',NULL,'Cambiar amortiguador izquierdo',NULL,NULL,'IPC 102',NULL,'si',NULL),(14,'2019-10-09','2019-10-24',NULL,NULL,'Ingresada',NULL,'cambio de aceite',NULL,NULL,'HCK 456',NULL,'si',NULL),(15,'2019-10-09','2019-10-16',NULL,NULL,'Ingresada',NULL,'sdfsdf',NULL,NULL,'HCK 456',NULL,'si',NULL),(16,'2019-10-09','2019-10-09',NULL,NULL,'En curso','Se agregaron 3 guardabarros','asd',NULL,NULL,'IPC 102',NULL,'si',1000.00);
...
INSERT INTO `repuestos` VALUES (2,'Foco Delantero',10.79,10),(3,'Guardabarro de falcon',4000.20,7),(4,'Amortiguador Trasero',3240.00,10),(8,'Capot',222.00,9);
...
INSERT INTO `usuario_y_contrasenia` VALUES ('1','1','');
...
-- Dump completed on 2019-11-11 16:01:00
